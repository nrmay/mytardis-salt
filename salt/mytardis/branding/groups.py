...
def run():
    ...
    try: 
        ...
        auth_group_2.permissions.add(  locate_object(Permission, "codename", Permission, "codename", u'add_datafile', {} )  )
        auth_group_2.permissions.add(  locate_object(Permission, "codename", Permission, "codename", u'change_datafile', {} )  )
